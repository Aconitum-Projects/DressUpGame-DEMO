...
namespace _Packages.FlexibleColorPicker.Scripts
{
    /// <summary>
    /// Handles persistence of FCP colors across scenes or gaming sessions
    /// </summary>
    [RequireComponent(typeof(global::FlexibleColorPicker))]
    public class FCP_Persistence : MonoBehaviour {
        ...
        private global::FlexibleColorPicker fcp;
        ...
        private void Awake() {
            fcp = GetComponent<global::FlexibleColorPicker>();
            InitStatic();
        }
